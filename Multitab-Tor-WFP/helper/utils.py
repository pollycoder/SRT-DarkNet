...
geckodrive_path = '/root/geckodriver'  # geckodriver path


#*********在这改动***********
MY_IP = "172.17.52.166"    # The host ip (run 'ifconfig' in terminal)
#*********在这改动***********

NOISE_IP = ['100.100.30.25', '100.100.30.26', '100.100.35.30', '100.103.0.47', 
            '100.103.0.45', '100.100.103.57', '100.100.30.60', '100.100.98.18'] 
USED_GATEWAY_IP = "172.17.63.253"  # run 'route -n' in terminal
...
INTERVAL_BETWEEN_TABS = 10   # [!!!]Interval time between tabs
INTERVAL_BETWEEN_COMBS = 5  # Interval time between instances
WAIT_AFTER_DUMP = 5          # Waiting time after opening dumpcap 
WAIT_FOR_COMB = 240         # Waiting time for each combination 
MAX_SITES_PER_TOR_PROCESS = 50
#SOFT_VISIT_TIMEOUT = 300     # timeout used by selenium and dumpcap
SOFT_VISIT_TIMEOUT = 300 #trying to solve timeout bug
