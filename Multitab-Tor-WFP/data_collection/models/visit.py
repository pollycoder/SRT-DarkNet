...
class Visit(object):
    ...
    def __init__(self, instance_num, page_urls, comb_dir, tor_controller, 
        ...
        self.tb_driver = TorBrowserDriver(tbb_path=self.tbb_path)
    ...
    def take_screenshot(self, index_url):
        try:
            ...
            print("ERROR\tException while taking screenshot of: %s" % self.page_urls)
            return False
        return True
    ...
    def get(self):
        ...
        for page_url in self.page_urls:
            ...
            sleep_time_tab=random.randint(3,10)
            time.sleep(sleep_time_tab)
