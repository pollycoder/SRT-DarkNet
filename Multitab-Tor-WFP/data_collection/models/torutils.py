...
class TorController(object):
    def __init__(self, torrc_dict, tbb_path, tor_log='tor.log'):
        self.torrc_dict = torrc_dict
        self.controller = None
        self.tmp_tor_data_dir = None
        self.tor_process = None
        self.tbb_path = tbb_path
        # tor_log='output/crawl+timestamped/logs/tor.log'
        self.log_file = tor_log
        # ua = UserAgent(family='firefox')
    ...
    def launch_tor_service(self):
        ...
        try:
            ...
            log.wl_log.critical("Error launching Tor", exc_info=True)
            sys.exit(1)
