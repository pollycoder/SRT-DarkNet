...
if __name__ == '__main__':  
    ...
    showScatter(X_plot_train, y_plot_train, X_plot_test, y_plot_test, "Result-PowerSpec-WTFPAD", acc, 1, n, max)
    showScatter(X_plot_raw, y_plot_train, X_plot_rawtest, y_plot_test, "Result-Raw-WTFPAD", 0.015894736842105264, 2, n, max)
    plt.show()